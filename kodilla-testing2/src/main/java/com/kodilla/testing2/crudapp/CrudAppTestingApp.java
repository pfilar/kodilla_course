...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_TEXTAREA = "//html/body/main/selection/from/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://pfilar.github.io/"); //  https://interceptor2048.github.io/
