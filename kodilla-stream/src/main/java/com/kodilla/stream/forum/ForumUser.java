...
public final class ForumUser {
    ...
    @Override
    public String toString() {                  // oparta o pola username, realname, location
        return "ForumUser{" +
                "username='" + username + '\'' +
                ", realName='" + realName + '\'' +
                ", location='" + location + '\'' +
    ...
    @Override
    public boolean equals(Object o) {           // oparta o pola username
    ...
    @Override
    public int hashCode() {                     // oparta o pola username
